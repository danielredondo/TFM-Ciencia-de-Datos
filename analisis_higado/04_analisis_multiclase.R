...
png(filename = "../../04_figuras/01_boxplot_all.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_figuras/02_boxplot_all_ordered.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_figuras/03_boxplot_primeros_10_genes.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_figuras/04_heatmap_primeros_10_genes.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../04_figuras/05_sankey.png", width = 8, height = 7)
...
png(filename = "../../04_figuras/06_svm_MRMR.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/07_svm_RF.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/08_svm_DA.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../04_figuras/09_svm_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_figuras/10_svm_accuracy.png", width = 8, height = 8)
...
png(filename = "../../04_figuras/11_svm_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_figuras/12_svm_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Gráficamente
png(filename = "../../04_figuras/13_svm_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/14_rf_MRMR.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(results_cv_rf_mrmr$accMatrix[, 1:10], colours = rainbow(numero_folds), mode = "classResults",
         main = "mRMR - Accuracy for each fold", xlab = "Genes", ylab = "Accuracy")
dev.off()

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/15_rf_RF.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(results_cv_rf_rf$accMatrix[, 1:10], colours = rainbow(numero_folds), mode = "classResults",
         main = "rf - Accuracy for each fold", xlab = "Genes", ylab = "Accuracy")
dev.off()

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/16_rf_DA.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../04_figuras/17_rf_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_figuras/18_rf_accuracy.png", width = 8, height = 8)
...
# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_figuras/19_rf_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_figuras/20_rf_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Gráficamente
png(filename = "../../04_figuras/21_rf_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(tabla, labels_test,
         mode = "confusionMatrix")
dev.off()
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/22_knn_MRMR.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(results_cv_knn_mrmr$accMatrix[, 1:10], colours = rainbow(numero_folds), mode = "classResults",
         main = "mRMR - Accuracy for each fold", xlab = "Genes", ylab = "Accuracy")
dev.off()

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/23_knn_RF.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(results_cv_knn_rf$accMatrix[, 1:10], colours = rainbow(numero_folds), mode = "classResults",
         main = "rf - Accuracy for each fold", xlab = "Genes", ylab = "Accuracy")
dev.off()

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_figuras/24_knn_DA.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../04_figuras/25_knn_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_figuras/26_knn_accuracy.png", width = 8, height = 8)
...
# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_figuras/27_knn_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_figuras/28_knn_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Gráficamente
png(filename = "../../04_figuras/29_knn_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
save(matriz, file =  "../saved_files/matriz_multiclase.RData")
toc()

# Guardar imagen
#save.image(file =  "../saved_files/workspace_multiclase.RData")
#load("../saved_files/workspace_multiclase.RData")
