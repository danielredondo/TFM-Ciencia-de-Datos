...
\subsection{Proteómica}

\subsection{Metabolómica}
...
\textcolor{red}{Apuntes asignatura:\\
	RNA-Seq: lo que se hace es contar, para cada gen, reads para ver si están sobreexpresados o infraexpresados. Luego, se comparan con una referencia (enfermos vs sanos). Como sólo se cuenta, los ficheros están anonimizados, y accesibles a menudo vía web.}\\

\textcolor{red}{Daniel: La
	genómica estudia el genoma como tal (Cromosomas, mutaciones y
	variaciones tanto de nucleótidos concretos como de regiones del genoma), sin embargo la transcriptómica estudia las transcripciones de los genes, transcripciones que luego son convertidas a proteínas. Tanto RNA-seq como microRNA, se enmarcan en el ámbito de transcriptómica.}
