...
\title{
	...
	\begin{center}
		{\LARGE \textbf{\bfseries{Epidemiología y detección de biomarcadores en cáncer de páncreas}}}
		\vspace{-0.75cm}
		\rule{136mm}{0.5mm}
	\end{center}
}
...
\date{\vspace{1cm}
	...
	\vspace{0.5cm}
	\includegraphics[height=2.5cm]{logos/logoUgr.png} \\ 
}
	...
	% Machine learning aplicado a genómica
	\include{cap4}
	
	% Detección de biomarcadores en cáncer de páncreas
	\include{cap5}
