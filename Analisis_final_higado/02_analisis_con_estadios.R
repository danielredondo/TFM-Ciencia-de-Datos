...
png(filename = "../../02_images/00_boxplot_all.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../02_images/01_boxplot_all_ordered.png", width = 13, height = 8, units = "in", res = 300)
...
# Número de genes extraídos: 5272
...
png(filename = "../../02_images/02_boxplot_primeros_12_genes.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(DEGsMatrix[1:12, ], labels, mode = "genesBoxplot")
dev.off()

# Mapa de calor para todas las muestras de los primeros genes
png(filename = "../../02_images/03_heatmap_primeros_12_genes.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../02_images/04_sankey.png", width = 8, height = 7)
...
png(filename = "../../02_images/05_svm_MRMR.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../02_images/06_svm_RF.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../02_images/07_svm_DA.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../02_images/08_svm_f1_score.png", width = 8, height = 8)

# Gráfico precisión
which(prec == max(prec), arr.ind = TRUE)
face_etiquetas <- rep("plain", 30)
face_etiquetas[22] <- "bold"
...
ggsave(filename = "../../02_images/09_svm_accuracy.png", width = 8, height = 8)

# ----- SVM: Resultados gráficos en train con el mejor método ------

# Imaginemos que el mejor ranking es mrmr con 8 genes
mejores_genes_svm <- mrmrRanking[1:8]

# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../02_images/10_heatmap_svm_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../02_images/11_boxplots_svm_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
results_svm_mrmr$cfMats[[8]]$table

# Gráficamente
png(filename = "../../02_images/12_matriz_confusion_svm_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../02_images/13_knn_MRMR.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(results_cv_knn_mrmr$accMatrix[, 1:12], colours = rainbow(numero_folds), mode = "classResults",
         main = "mRMR - Accuracy for each fold", xlab = "Genes", ylab = "Accuracy")
dev.off()

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../02_images/14_knn_RF.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(results_cv_knn_rf$accMatrix[, 1:12], colours = rainbow(numero_folds), mode = "classResults",
         main = "rf - Accuracy for each fold", xlab = "Genes", ylab = "Accuracy")
dev.off()

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../02_images/15_knn_DA.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../02_images/16_knn_f1_score.png", width = 8, height = 8)

# Gráfico precisión
which(prec == max(prec), arr.ind = TRUE)

face_etiquetas <- rep("plain", 30)
face_etiquetas[7] <- "bold"
...
ggsave(filename = "../../02_images/17_knn_accuracy.png", width = 8, height = 8)

# --- Mejor método en CV basado en F1-score

# El mejor ranking es RF con 20 genes
mejores_genes_knn <- mrmrRanking[1:3]

# ----- kNN: Resultados gráficos en train con el mejor método ------

# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../02_images/18_heatmap_knn_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../02_images/19_boxplots_knn_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Matriz de confusión mejor clasificador
results_knn_mrmr$cfMats[[3]]$table

# Gráficamente
png(filename = "../../02_images/20_matriz_confusion_knn_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
