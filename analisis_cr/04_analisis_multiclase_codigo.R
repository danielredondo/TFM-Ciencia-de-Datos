...
# Añadir código del tumor: leer datos clínicos
clinical <- read_delim("../data/clinical.cart.2020-06-11/clinical.tsv", "\t", escape_double = FALSE, trim_ws = TRUE) %>% 
  select(case_submitter_id, codigo = icd_10_code) %>% 
  unique

# Anexar código
tumores <- samplesInfo %>% filter(Sample.Type == "Primary Tumor")
nrow(tumores) == nrow(clinical) # Comprobación: no todos los tumores tienen datos clínicos
...
samplesInfo <- samplesInfo %>% filter(Sample.Type != "Primary Tumor") %>%
  mutate(codigo = "Solid Tissue Normal") %>%
  rbind(tumores)

# Recodificación morfologías
table(samplesInfo$codigo, useNA = "always")

samplesInfo$codigo <- substr(samplesInfo$codigo, 1, 3)
samplesInfo[is.na(samplesInfo$codigo), "codigo"] <- "otros"
samplesInfo[samplesInfo$codigo == "Sol", "codigo"] <- "tejido_normal"
samplesInfo[samplesInfo$codigo == "C83", "codigo"] <- "otros"
samplesInfo[samplesInfo$codigo == "C19", "codigo"] <- "C1920"
samplesInfo[samplesInfo$codigo == "C20", "codigo"] <- "C1920"

# Quitar morfología de clases minoritarias
samplesInfo <- samplesInfo %>% filter(codigo != "otros")
...
png(filename = "../../04_analisis_multiclase_codigo/01_boxplot_all.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(expressionMatrix, labels, mode = "boxplot", colours = c("red", "orange", "green"))
legend(1, 29, c("C18", "C1920", "tejido_normal"),
       fill = c("red", "orange", "green"), xpd = TRUE)
title("Boxplot de matriz de expresión para todos los genes")
dev.off()

png(filename = "../../04_analisis_multiclase_codigo/02_boxplot_all_ordered.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_codigo/03_boxplot_primeros_genes.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_codigo/04_heatmap_primeros_genes.png", width = 13, height = 8, units = "in", res = 300)
DEGsMatrix_heatmap <- DEGsMatrix[, c(which(labels == "C18"),
                                     which(labels == "C1920"),
                                     which(labels == "tejido_normal"))]
labels_heatmap <- labels[c(which(labels == "C18"),
                           which(labels == "C1920"),
                           which(labels == "tejido_normal"))]
...
ggsave(filename = "../../04_analisis_multiclase_codigo/05_sankey.png", width = 8, height = 7)
...
write.csv2(genes, file = "../../04_analisis_multiclase_codigo/genes.csv")
...
write.csv2(mejores_parametros_svm, file = "../../04_analisis_multiclase_codigo/mejores_parametros_svm.csv")

# ----- SVM: Resultados gráficos de validación cruzada -----

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/06_svm_MRMR_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/07_svm_RF_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/08_svm_DA_f1.png", width = 13, height = 6, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/09_svm_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/10_svm_accuracy.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/11_svm_sensibilidad.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/12_svm_especificidad.png", width = 8, height = 8)

# ----- SVM: Resultados gráficos en train con el mejor método ------

mejores_genes_svm <- mrmrRanking[1:10]

# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_analisis_multiclase_codigo/13_svm_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
DEGsMatrix_heatmap <- DEGsMatrix[mejores_genes_svm, c(which(labels == "C18"),
                                                      which(labels == "C1920"),
                                                      which(labels == "tejido_normal"))]
labels_heatmap <- labels[c(which(labels == "C18"),
                           which(labels == "C1920"),
...
png(filename = "../../04_analisis_multiclase_codigo/14_svm_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
tabla <- results_svm_mrmr$cfMats[[20]]$table

# Gráficamente
png(filename = "../../04_analisis_multiclase_codigo/15_svm_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/16_rf_MRMR_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/17_rf_RF_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/18_rf_DA_f1.png", width = 13, height = 6, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/19_rf_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/20_rf_accuracy.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/21_rf_sensibilidad.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/22_rf_especificidad.png", width = 8, height = 8)
...
# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_analisis_multiclase_codigo/23_rf_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
DEGsMatrix_heatmap <- DEGsMatrix[mejores_genes_rf, c(which(labels == "C18"),
                                                     which(labels == "C1920"),
                                                     which(labels == "tejido_normal"))]
labels_heatmap <- labels[c(which(labels == "C18"),
                           which(labels == "C1920"),
...
png(filename = "../../04_analisis_multiclase_codigo/24_rf_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Matriz de confusión mejor clasificador
tabla <- results_rf_mrmr$cfMats[[20]]$table

# Gráficamente
png(filename = "../../04_analisis_multiclase_codigo/25_rf_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(tabla, labels_test,
         mode = "confusionMatrix")
dev.off()
...
write.csv2(mejores_parametros_knn, file = "../../04_analisis_multiclase_codigo/mejores_parametros_knn.csv")

# ----- kNN: Resultados gráficos de validación cruzada -----

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/26_knn_MRMR_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/27_knn_RF_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_codigo/28_knn_DA_f1.png", width = 13, height = 6, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/29_knn_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/30_knn_accuracy.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/31_knn_sensibilidad.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_codigo/32_knn_especificidad.png", width = 8, height = 8)
...
# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_analisis_multiclase_codigo/33_knn_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
DEGsMatrix_heatmap <- DEGsMatrix[mejores_genes_knn, c(which(labels == "C18"),
                                                      which(labels == "C1920"),
                                                      which(labels == "tejido_normal"))]
labels_heatmap <- labels[c(which(labels == "C18"),
                           which(labels == "C1920"),
...
png(filename = "../../04_analisis_multiclase_codigo/34_knn_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Matriz de confusión mejor clasificador
tabla <- results_knn_mrmr$cfMats[[20]]$table

# Gráficamente
png(filename = "../../04_analisis_multiclase_codigo/35_knn_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
