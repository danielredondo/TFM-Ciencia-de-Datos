...
samplesInfo[samplesInfo$primary_diagnosis == "Adenocarcinoma, NOS", "primary_diagnosis"] <- "carc_hepatocelular"
samplesInfo[samplesInfo$primary_diagnosis == "Mucinous adenocarcinoma", "primary_diagnosis"] <- "colangiocarcinoma"
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/01_boxplot_all.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/02_boxplot_all_ordered.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/03_boxplot_primeros_genes.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/04_heatmap_primeros_genes.png", width = 13, height = 8, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/05_sankey.png", width = 8, height = 7)
...
write.csv2(genes, file = "../../04_analisis_multiclase_primary_diagnosis/genes.csv")
...
write.csv2(mejores_parametros_svm, file = "../../04_analisis_multiclase_primary_diagnosis/mejores_parametros_svm.csv")

# ----- SVM: Resultados gráficos de validación cruzada -----

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/06_svm_MRMR_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/07_svm_RF_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/08_svm_DA_f1.png", width = 13, height = 6, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/09_svm_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/10_svm_accuracy.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/11_svm_sensibilidad.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/12_svm_especificidad.png", width = 8, height = 8)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/13_svm_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/14_svm_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Gráficamente
png(filename = "../../04_analisis_multiclase_primary_diagnosis/15_svm_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/16_rf_MRMR_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/17_rf_RF_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/18_rf_DA_f1.png", width = 13, height = 6, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/19_rf_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/20_rf_accuracy.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/21_rf_sensibilidad.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/22_rf_especificidad.png", width = 8, height = 8)
...
# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_analisis_multiclase_primary_diagnosis/23_rf_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/24_rf_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Gráficamente
png(filename = "../../04_analisis_multiclase_primary_diagnosis/25_rf_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
dataPlot(tabla, labels_test,
         mode = "confusionMatrix")
dev.off()
...
write.csv2(mejores_parametros_knn, file = "../../04_analisis_multiclase_primary_diagnosis/mejores_parametros_knn.csv")

# ----- kNN: Resultados gráficos de validación cruzada -----

# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/26_knn_MRMR_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/27_knn_RF_f1.png", width = 13, height = 6, units = "in", res = 300)
...
# Plotting the accuracy of all the folds evaluated in the CV process
png(filename = "../../04_analisis_multiclase_primary_diagnosis/28_knn_DA_f1.png", width = 13, height = 6, units = "in", res = 300)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/29_knn_f1_score.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/30_knn_accuracy.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/31_knn_sensibilidad.png", width = 8, height = 8)
...
ggsave(filename = "../../04_analisis_multiclase_primary_diagnosis/32_knn_especificidad.png", width = 8, height = 8)
...
# Se grafican boxplots y mapas de calor con el mejor método
png(filename = "../../04_analisis_multiclase_primary_diagnosis/33_knn_heatmap_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
png(filename = "../../04_analisis_multiclase_primary_diagnosis/34_knn_boxplots_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
...
# Gráficamente
png(filename = "../../04_analisis_multiclase_primary_diagnosis/35_knn_matriz_confusion_mejor_metodo.png", width = 13, height = 8, units = "in", res = 300)
