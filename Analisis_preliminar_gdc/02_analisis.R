...
# Matrices de confusión para 1 gen
...
# ----- Mejor método hallado en validación cruzada (mrmr, 10 genes) -----
...
# ----- Resultados de knn gráficamente -----
...
diseases
# Uno de los genes se quitar por no tener enfermedades relacionadas
